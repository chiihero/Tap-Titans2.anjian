package com.chii.tt2info.swipe;
...
public class SwipeLayout extends FrameLayout {
    ...
    private Map<View, Rect> mViewBoundCache = new HashMap<>();//save all children's bound,
    // restore in onLayout
     ...
     * {@link com.chii.tt2info.swipe.SwipeLayout.OnRevealListener}
     *
     ...
     * @param l        the {@link com.chii.tt2info.swipe.SwipeLayout.OnRevealListener}
     */
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!beforeCheck && mIsBeingDragged) {
                    //let children has one chance to catch the touch, and request the swipe not
                    // intercept
     ...
     * if it was already open before dragging
     *
     * @param willOpenPercentAfterOpen The percentage of view revealed to trigger, default value
     *                                 is 0.25
     */
     ...
     * if it was already closed before dragging
     *
     * @param willOpenPercentAfterClose The percentage of view revealed to trigger, default value
     *                                 is 0.75
     */
     ...
     * {@link com.chii.tt2info.swipe.SwipeLayout.ShowMode}.PullOut and
     * {@link com.chii.tt2info.swipe.SwipeLayout.ShowMode}.LayDown.
     *
     * @param mode
     */
     ...
     * get the open status.
     *
     * @return {@link com.chii.tt2info.swipe.SwipeLayout.Status} Open , Close or
     * Middle.
     */
